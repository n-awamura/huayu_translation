...
*   **重要:** Web検索を行う際は、いかなる位置情報も利用せず、全世界を対象とした一般的な検索結果を使用してください。
...
**1. 翻訳と拼音**
「テキスト/テーマ」を自然な台湾華語（繁体字中国語）に翻訳し、拼音（ピンイン）を付記してください。カタカナのルビは不要です。「テキスト/テーマ」が長文の場合は、全文を翻訳してください。

**2. 例文と文法解説**
翻訳した台湾華語の中から主要な単語を1つ選び、その単語を使った例文を台湾華語（繁体字中国語）で、拼音（ピンイン）を付けて提示してください。その下に、例文の日本語訳と簡単な文法解説を日本語で提供してください。

**3. 関連情報**
「テキスト/テーマ」に関する興味深い関連情報や豆知識を、日本語で詳しく解説してください。「テキスト/テーマ」が長文の場合は、関連情報は簡潔にしてください。
